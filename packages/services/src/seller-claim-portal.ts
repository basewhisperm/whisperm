...
import type { AuditLogRepository, DealsRepository, DraftInventoryRecord, DraftInventoryRepository, MarketplaceCaptureRecord, MarketplaceCaptureRepository, MarketplaceOwnershipAttestationRepository, PipelineRepository } from "@whisperm/repositories";
...
export interface SellerClaimPortalDependencies { readonly claimTokens: ClaimTokenRepository; readonly marketplaceCaptures: MarketplaceCaptureRepository; readonly draftInventories: DraftInventoryRepository; readonly ownershipAttestations: MarketplaceOwnershipAttestationRepository; readonly pipelines: PipelineRepository; readonly deals: DealsRepository; readonly auditLogs: AuditLogRepository; readonly clock?: (() => Date) | undefined; }
