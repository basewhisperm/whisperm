...
export interface SellerClaimPortalDependencies { readonly claimTokens: ClaimTokenRepository; readonly marketplaceCaptures: MarketplaceCaptureRepository; readonly draftInventories: DraftInventoryRepository; readonly ownershipAttestations: MarketplaceOwnershipAttestationRepository; readonly pipelines: PipelineRepository; readonly deals: DealsRepository; readonly auditLogs: AuditLogRepository; readonly activities?: ActivityRepository | undefined; readonly clock?: (() => Date) | undefined; }
