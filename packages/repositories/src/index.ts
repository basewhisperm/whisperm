...
import { MarketplaceCaptureService as MarketplaceAcquisitionCaptureService } from "./marketplace-acquisition/capture-service.js";
...
export interface WhispeRMServices {
  ...
  readonly marketplaceCaptures: MarketplaceAcquisitionCaptureService;
...
export const createWhispeRMServices = (dependencies: ServiceDependencies): WhispeRMServices => ({
  ...
  marketplaceCaptures: new MarketplaceAcquisitionCaptureService(dependencies),
